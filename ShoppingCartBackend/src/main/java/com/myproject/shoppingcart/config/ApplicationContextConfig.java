...
import org.springframework.beans.factory.annotation.Autowired;						//requires H2 dependency
import org.springframework.context.annotation.Bean;									//requires H2 dependency
...
@Configuration
@ComponentScan("com.myproject.shoppingcart")
...
public class ApplicationContextConfig {
	...
	public DataSource getDataSource(){
		...
		dataSource.setUrl("jdbc:h2:tcp://localhost/~/mycart");
